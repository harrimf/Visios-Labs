        ...
        <Container>
          <Row className='headerRow'>
            <Col className='contactCol'>
              <h2 className='valueH2'>Contact us</h2>
              <p className='valueP'>Fill out the form, and we'll reach out as soon as possible! <br></br>Or email us at: contact@visioslabs.com.</p>
              ...
              <Form>
                ...
                <Form.Group className='contactForm' controlId="formBasicEmail">
                    <Form.Label className='contactLabel'>What would you like to know?</Form.Label>
